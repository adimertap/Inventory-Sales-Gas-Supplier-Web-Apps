...
<main>
                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title">
                            ...
                            Proses Penerimaan Pembelian Kode {{ $pembelian->kode_pembelian }}
                        </h1>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid mt-4">
        <form action="{{ route('penerimaan.store') }}" id="form" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control" id="kode_penerimaan" type="text" name="kode_penerimaan"
                                                value="{{ $kode_penerimaan }}" readonly />
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control" id="id_supplier" type="text" name="id_supplier"
                                                placeholder="Auto Generate" value="{{ $pembelian->Supplier->nama_supplier }}" readonly>
                                        </div>
                                        <div class="form-group col-md-4">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="form-control" name="id_produk" class="form-control"
                                                ...
                                                @foreach ($pembelian->detail as $produks)
...
<script>
    ...
    function TambahProduk(event) {
        ...
        } else if(parseInt(jumlah) > parseInt(jumlah_order)){
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Jumlah Penerimaan Tidak Boleh Melebihi Jumlah Order',
            })
        }else {
