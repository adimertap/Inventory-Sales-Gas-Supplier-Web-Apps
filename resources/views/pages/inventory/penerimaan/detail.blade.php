            ...
            <div class="card-header p-4 p-md-5 border-bottom-0 bg-gray-300 text-black-50">
                <div class="row justify-content-between align-items-center">
                    <div class="col-12 col-lg-auto mb-5 mb-lg-0 text-center text-lg-left">
                        ...
                        {{ $transaksi->kode_penerimaan }}, Diterima pada {{ date('d-M-Y', strtotime($transaksi->tanggal_penerimaan )) }}
                    </div>
                    <div class="col-12 col-lg-auto text-center text-lg-right">
                        <!-- Invoice details-->
                        <div class="h3 text-black">Invoice Pembelian</div>
                        Kode Pembelian #{{ $transaksi->Pembelian->kode_pembelian }}
                        <br>Dipesan pada {{ date('d-M-Y', strtotime($transaksi->Pembelian->tanggal_pembelian )) }}
                    </div>
                </div>
            </div>
            <div class="card-body p-4 p-md-5">
                <div class="row">
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                        ...
                        <div class="h6 mb-1">{{ $transaksi->Pembelian->Supplier->nama_supplier }}</div>
                        <div class="small">{{ $transaksi->Pembelian->Supplier->email_supplier }}/{{ $transaksi->Pembelian->Supplier->no_hp_supplier }}</div>
                        <div class="small">{{ $transaksi->Pembelian->Supplier->alamat_supplier }}</div>
                    </div>
                    <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                    ...
                    <table class="table table-borderless mb-0">
                        <thead class="border-bottom">
                            <tr class="small text-uppercase text-muted">
                                ...
                                <th class="text-center" scope="col">Jumlah Diterima</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-bottom">
                                ...
                                <td class="text-center font-weight-bold">{{ $item->pivot->jumlah_diterima }}</td>
                                <td class="text-center font-weight-bold">{{ number_format($item->pivot->harga_diterima) }}</td>
                                <td class="text-right font-weight-bold">{{ number_format($item->pivot->total_diterima) }}</td>
                            </tr>
                            @empty
                            ...
                            <!-- Invoice total-->
                            <tr>
                                <td class="text-right pb-0" colspan="4"><div class="text-uppercase small font-weight-700 text-muted">Grand Total Pembelian (IDR):</div></td>
