                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title">
                            ...
                            Detail Kartu Gudang Penerimaan
                        </h1>
                    </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-8 col-xxl-12">
                            <nav class="nav nav-borders">
                                ...
                                <a class="nav-link active ml-0" href="{{ route('kartu-gudang-penerimaan', $produk->id_produk) }}">Kartu Penerimaan</a>
                                <a class="nav-link" href="{{ route('kartu-gudang-penjualan', $produk->id_produk) }}">Kartu Penjualan</a>
                            </nav>
                            <hr>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered table-hover dataTable" id="dataTable" width="100%"
                                    ...
                                    <tbody>
                                        @forelse ($kartu_penerimaan as $item)
