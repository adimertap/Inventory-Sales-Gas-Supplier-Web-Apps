...
<main>
    ...
    <div class="container-fluid mt-4">
        <form action="{{ route('pembelian.store') }}" id="form" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row">
                                ...
                                <div class="col-xxl-12 col-xl-8">
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control" id="kode_pembelian" type="text"
                                                name="kode_pembelian" value="{{ $kode_pembelian }}" readonly />
                                        </div>
                                        <div class="form-group col-md-4">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input class="form-control" id="grand_total" type="text" name="grand_total"
                                                placeholder="Auto Generate" value="0" readonly>
                                        </div>
                                        <div class="form-group col-md-4">
