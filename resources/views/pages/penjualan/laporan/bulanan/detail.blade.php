            ...
            <div class="page-header-content">
                <div class="row align-items-center justify-content-between pt-3">
                    ...
                    <div class="col-12 col-xl-auto mb-3">
                        <a href="{{ route('laporan-penjualan-bulanan.index') }}" class="btn btn-sm btn-light text-primary active mr-2">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid mt-4">
        <div class="d-flex justify-content-between align-items-sm-center flex-column flex-sm-row mb-4">
            <div class="mr-4 mb-3 mb-sm-0">
                <h1 class="mb-0">Laporan Penjualan Bulan {{ $bulan }}</h1>
                <div class="small">
            ...
            <div class="col-12 col-xl-auto mb-3 mb-sm-0  mr-4">
                ...
                <form id="form1">
                    <div class="row input-daterange">
                        <input type="hidden" value="{{ $bulan }}" name="bulan_penjualan">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 mt-2">
                            <button type="button" name="filter" onclick="filter_tanggal(event)"
                                ...
                                <a href="{{ route('laporan-penjualan-bulanan-reset', $bulan) }}" type="button"
                                ...
                                <table class="table table-bordered table-hover dataTable" id="dataTable" width="100%"
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="1" class="text-center">
                                            <a href="{{ route('penjualan-detail-bulanan-pdf', $bulan) }}" class="btn btn-info btn-sm" data-bs-toggle="tooltip"
...
<script>
    ...
    function filter_tanggal(event) {
        ...
        var bulan = form1.find('input[name="bulan_penjualan"]').val()
        ...
        window.location.href = '/laporan-penjualan-bulanan/'+bulan+'/?from=' + tanggal_mulai + '&to=' + tanggal_selesai
    }
</script>
