...
<body class="nav-fixed">
            ...
            <li class="nav-item dropdown no-caret mr-2 dropdown-user">
                <a class="btn btn-icon btn-transparent-dark dropdown-toggle" id="navbarDropdownUserImage"
                    ...
                    aria-expanded="false"><img class="img-fluid"
                        src="/template/src/assets/img/freepik/profiles/profile-6.png" /></a>
                <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up"
    ...
    <footer class="footer my-auto footer-light">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12 text-center">Copyright &copy; 2021 Aplikasi Inventory & Penjualan Sukses Berkah Bertumbuh</div>
            </div>
        </div>
    </footer>
